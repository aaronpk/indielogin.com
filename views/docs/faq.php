...
### Why does <?= Config::$name ?> ask for permission to ___ my GitHub account? {#github-permissions}

If you choose to authenticate with GitHub, <?= Config::$name ?> uses the GitHub API to verify your account. The least amount of permissions this site can request from GitHub is _____. This site does not actually access your GitHub account other than to verify your username. Your GitHub token is never stored by this site or ptovided to the site you're logging in to.
