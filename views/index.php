...
<div class="container container-full marketing">
  ...
  <div class="row featurette">
    <div class="col-md-7">
      ...
      <p><?= getenv('APP_NAME') ?> supports <a href="https://indieauth.net/">IndieAuth</a>, so users with supported websites will be able to sign in using their own website's login. Otherwise, <?= getenv('APP_NAME')?> will check for links to Twitter, GitHub, Codeberg, an email address or PGP key, and will ask the user to authenticate that way. Regardless of how the user authenticates, the identity provided to the application will always be the user's primary website.</p>
    </div>
    <div class="col-md-5">
